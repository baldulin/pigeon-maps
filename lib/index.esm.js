...
var Map = /*#__PURE__*/ (function (_Component) {
  ...
  function Map(props) {
    ...
    _this.bindFullscreenEvent = function () {
      document.addEventListener('fullscreenchange', _this.handleFullscreen)
    }

    _this.unbindFullscreenEvent = function () {
      document.removeEventListener('fullscreenchange', _this.handleFullscreen)
    }
    ...
    _this.handleFullscreen = function (event) {
      if (document.fullscreenElement === _this._containerRef) {
        _this.setState({
          isFullscreen: true,
        })
      } else {
    ...
    _this.toggleFullscreen = function () {
      if (_this._containerRef) {
        if (_this.state.isFullscreen) {
          ...
          _this._containerRef.requestFullscreen()
        }
      }
    }
    ...
    _this.attachOverlayChild = function (child, mapState) {
      if (!child) {
        return null
      }
      ...
      if (!mapState) {
        var _this$state10 = _this.state,
          ...
          center = _this$state10.center,
          isFullscreen = _this$state10.isFullscreen
        mapState = {
      ...
      var c = _this.latLngToPixel(anchor || position || _this.state.center)

      return /*#__PURE__*/ React.cloneElement(child, {
        left: c[0] - (offset ? offset[0] : 0),
        top: c[1] - (offset ? offset[1] : 0),
        latLngToPixel: _this.latLngToPixel,
        pixelToLatLng: _this.pixelToLatLng,
        setCenterZoom: _this.setCenterZoomForChildren,
        attachOverlayChild: _this.attachOverlayChild,
        toggleFullscreen: _this.toggleFullscreen,
        mapProps: _this.props,
        mapState: mapState,
      })
    }
  ...
  _proto.renderTiles = function renderTiles() {
    ...
    var _this$state12 = this.state,
      oldTiles = _this$state12.oldTiles,
  ...
  _proto.renderOverlays = function renderOverlays() {
    ...
    var _this$state13 = this.state,
      ...
      center = _this$state13.center,
      isFullscreen = _this$state13.isFullscreen
    var mapState = {
    ...
    var childrenWithProps = React.Children.map(this.props.children, function (child) {
      return _this4.attachOverlayChild(child, mapState)
    })
    var childrenStyle = {
      position: 'absolute',
      width: width,
  ...
  _proto.renderWarning = function renderWarning() {
    ...
    var _this$state14 = this.state,
      showWarning = _this$state14.showWarning,
      warningType = _this$state14.warningType,
...
function Polygon(props) {
  ...
  var p = props.polygon.reduce(function (a, part) {
    return (
      a +
      ' M' +
      part.reduce(function (a, _ref) {
        var y = _ref[0],
          x = _ref[1]
...
function GeoJsonFeature(props) {
  var _useState2 = useState(props.hover || false),
    internalHover = _useState2[0],
    setInternalHover = _useState2[1]

  var hover = props.hover || internalHover
...
export { Draggable, GeoJson, GeoJsonLoader, Map, Marker, Overlay, ZoomControl }
